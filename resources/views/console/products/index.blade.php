...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Konsol /</span> Manajemen Produk</h4>
...
@push('scripts')
    ...
    <script>
        var urlDeleteProduct = "{{ route('products.destroy', ':id') }}";
    </script>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const handleDeleteRecord = (e) => {
                ...
                form.method = "POST";
                form.action = urlDeleteProduct.replace(":id", recordId);
